...
public class LazyFragment extends RxFragment {
    ...
    private static final String TAG_ROOT_FRAME_LAYOUT = "tag_root_frame_layout";
    ...
    private void onCreateView(Bundle savedInstanceState) {
        ...
        if (isLazyEnable) {
            if (isVisible && !isInitReady) {
                ...
                layout.setTag(TAG_ROOT_FRAME_LAYOUT);
    ...
    protected View getRealRootView() {
        if (rootView != null) {
            if (rootView instanceof FrameLayout
                    && TAG_ROOT_FRAME_LAYOUT.equals(rootView.getTag())) {
